...
- Demonstrates essential SQL operations: SELECT, JOINs, INSERT, DELETE
- Perfect for database design practice, assignments, or personal projects

## Entity Relationship Diagram (ERD)

![Entity Relationship Diagram](IMG-20250412-WA0023.jpg)

> Make sure this image is in the same directory as your README file when pushing to GitHub.
...
3. Create roles and assign privileges
4. Execute provided SELECT queries to explore data relationships

## Tech Stack

- **MySQL**
- ERD created using **draw.io**
- Compatible with **MySQL Workbench**, **phpMyAdmin**, or command-line tools
